...
import { asyncLoadMovies, removeMovieDetails } from '../store/actions/MovieAction';
    ...
    <div style={{
      ...
      <div className='my-5 flex justify-between items-center overflow-auto'>
        ...
        <div className='flex gap-5'>
          <a href={`https://www.imdb.com/title/${info.details.imdb_id}/`} target='_blank' className='inline-block bg-yellow-500 py-3 px-1 font-extrabold rounded-lg'>IMDb</a>
